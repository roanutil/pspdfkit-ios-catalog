    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        ...
        pdfController.annotationToolbarController!.annotationToolbar.configurations = [
            ...
            AnnotationToolConfiguration(annotationGroups: [
                ...
                .init(items: [polygonalArea, ellipticalArea, rectangularArea, selection]),
            ]),
            ...
            AnnotationToolConfiguration(annotationGroups: [
                ...
                .init(items: [ellipticalArea, rectangularArea, selection]),
            ]),
            ...
            // All six tools in separate groups for when there is plenty of space.
            AnnotationToolConfiguration(annotationGroups: [
                .init(items: [distance]),
                .init(items: [perimeter]),
                .init(items: [polygonalArea]),
