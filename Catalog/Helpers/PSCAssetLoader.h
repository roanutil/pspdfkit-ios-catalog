...
FOUNDATION_EXTERN PSCAssetName const PSCAssetNameQuizTeacher;
FOUNDATION_EXTERN PSCAssetName const PSCAssetNameQuizStudent;
FOUNDATION_EXTERN PSCAssetName const PSCAssetNameFoodAndDrinks;
...
FOUNDATION_EXTERN PSCAssetName const PSCAssetNameFloorPlan;
